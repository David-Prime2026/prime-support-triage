# Bug-vs-Change classification method (RATIFIED)
**Status:** Ratified by PRIME · DR-CS-PLATFORM-006 · **Tier 1 prod-eligible = ON (fenced 1.1–1.5 only)**  
**Owner:** PRIME · **Author:** Cursor (DR-CS-PLATFORM-002 method; DR-006 enable)  
**Machine-checkable companion:** `bug-change-classification.json`  
**Conservatism:** Default DOWN on any uncertainty. ~40% is not a target.
